...
class News(models.Model):
    ...
    category = models.ForeignKey(Category, on_delete=models.DO_NOTHING, verbose_name='Categoria de la Noticia') #  TODO: add related name
    ...
    status = models.CharField(max_length=10, choices=STATUS_CHOICES, default='borrador', verbose_name='Estado de la Noticia')
    ...
    def get_absolute_url(self):
        return reverse('news:news_detail', args=[self.category, self.publish.year, self.publish.month, self.publish.day, self.slug])
